...
#else   // CS is IO5, MOSI is 23, SCK is 18, CS is IO5 我的接线
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ EPD_CS, /*DC=*/ 4, /*RST=*/ 16, /*BUSY=*/ 17)); // my suggested wiring and proto board
